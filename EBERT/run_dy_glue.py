...
from models import modeling_ebert, modeling_eroberta, modeling_eelectra, modeling_edistilbert
...
MODELS = {
    ...
    'electra': modeling_eelectra.ElectraForSequenceClassification,
    'distilbert': modeling_edistilbert.DistilBertForSequenceClassification,
}
